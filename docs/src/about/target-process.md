...
![Process flow diagram illustrating the application lifecycle from submission by citizens, through internal caseworker processing, interactions with Form Server, Zammad, and E-Akte, to approval, rejection, and final closure.](./target-process.png)
