    ...
    @Mappings(
        {
                ...
                @Mapping(target = "vertretungsberechtigter.nachname", constant = "Musterfrau"),
                @Mapping(target = "vertretungsberechtigter.vorname", constant = "Erika"),
                @Mapping(target = "vertretungsberechtigter.telefonNr", constant = "01234567"),
                @Mapping(target = "vertretungsberechtigter.email", constant = "erika.musterfrau@muster.de"),
                @Mapping(target = "vertretungsberechtigter.mobilNr", constant = "01234567"),
                @Mapping(
