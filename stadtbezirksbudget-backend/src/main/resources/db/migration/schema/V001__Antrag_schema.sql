...
(
    ...
    projekt_beschreibung                               VARCHAR(2000)               NOT NULL CHECK (antrag.projekt_beschreibung <> ''),
    antragsteller_name                                 VARCHAR(513)                NOT NULL CHECK (antrag.antragsteller_name <> ''),
    antragsteller_telefon_nr                           VARCHAR(256)                NOT NULL,
    ...
    antragsteller_zielsetzung                          VARCHAR(2000)               NOT NULL CHECK (antrag.antragsteller_zielsetzung <> ''),
    antragsteller_adresse_strasse_hausnummer           VARCHAR(513)                NOT NULL CHECK (antrag.antragsteller_adresse_strasse_hausnummer <> ''),
    antragsteller_adresse_weitere_angaben              VARCHAR(256)                NOT NULL,
    ...
    bankverbindung_ist_von_vertretungsberechtigtem     BOOLEAN                     NOT NULL,
