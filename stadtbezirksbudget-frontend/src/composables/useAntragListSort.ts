import {ref} from "vue";
import {type AntragListSort, type AntragListSortOption, createEmptyListSort} from "@/types/AntragListSort.ts";
...
export function useAntragListSort() {
    ...
    function updateSorting(newValue: AntragListSortOption) {
        ...
        sortingStore.setListSorting({...createEmptyListSort(), [newValue.sortBy]: newValue})
