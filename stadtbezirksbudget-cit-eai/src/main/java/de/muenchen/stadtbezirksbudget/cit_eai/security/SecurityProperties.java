...
import de.muenchen.stadtbezirksbudget.cit_eai.configuration.filter.RequestResponseLoggingFilter;
...
public class SecurityProperties {
    ...
    /**
     * Gets the logging ignore list as matchers.
     *
     * @return the logging ignore list
     */
    ...
    /**
     * Gets the logging ignore list as strings.
     *
     * @return the logging ignore list
     */
    ...
    /**
     * Sets the logging ignore list from strings.
     *
     * @param patterns the logging ignore list
     */
